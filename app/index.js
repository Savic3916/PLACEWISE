  ...
  return (
    <View style={styles.container}>
      <View style={styles.textContainer}>
        ...
        <Text style={styles.otherText}>We'll start with these listings. You</Text>
      ...
      <View>
        <Button hasIcon={true}
                ...
                textStyle={{fontWeight: '500', fontSize: deviceWidth < 321? 14 : 15}} 
                onPress={purchaseHomeButtonHandler}
        />
        <Button hasIcon={true}
                buttonContainerWIthIcon={styles.buttonContainerWIthIcons}  
                imageSource={require('../assets/images/rent.png')} 
                text='Rent a home' textStyle={{fontWeight: '500', fontSize: deviceWidth < 321? 14 : 15}} 
      ...
      <View style={{marginTop: deviceHeight < 569? '10%' : '15%'}}>
        <Button hasIcon={false}
                ...
                text='SKIP' 
                textStyle={{fontWeight: '500', fontSize: deviceWidth < 321? 15 : 18, color: 'white', letterSpacing: 5}} 
